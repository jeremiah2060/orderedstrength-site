...
ALT = {
    ...
    'alt="The same dashboard after one hundred sessions, this time with the athlete\'s soreness reported. Fatigue and recovery are both labelled Your Data, recovery reads 73%, and the headline says his load and his recovery rate are both measured from him now."':
        'alt="El mismo panel después de cien sesiones, esta vez con el dolor muscular del atleta reportado. La fatiga y la recuperación están etiquetadas Tus datos, la recuperación marca 73 por ciento, y el titular dice que su carga y su tasa de recuperación ahora se miden a partir de él."',
